...
<main>
            <div class="side-nav">
                <ul class="list-group list-group-flush">
                    ...
                    <a class="list-group-item" href="{{route('admin.showRooms')}}" data-toggle="tooltip" data-placement="bottom" title="Notifications">
                        <i class="las la-sms la-lw"></i>
                        <span>Rooms</span>
                    </a>
                    <a class="list-group-item" href="{{route('admin.showNurses')}}" data-toggle="tooltip" data-placement="bottom" title="Procurement">
                        <i class="las la-shopping-cart la-lw"></i>
                        <span>Nurses</span>
                    </a>
                    <a class="list-group-item" href="{{route('admin.showpattients')}}" data-toggle="tooltip" data-placement="bottom" title="Patients">
