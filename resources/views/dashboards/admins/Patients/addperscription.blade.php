...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('per/style.css')}}">
...
<div class="wrapper">
    <div class="prescription_form">
        <table class="prescription" data-prescription_id="" border="1">
            <tbody>
                <tr height="15%">
                    <td colspan="2">
                        <div class="header">
                        ...
                        <div class="desease_details">
                            <div class="symptoms">
                                ...
                                <div class="symp_action">
                                    <button id="symp_save" data-prescription_id="<?php  ?>" class="btn btn-sm btn-success save">Save</button>
                            ...
                            <div class="tests">
                                ...
                                <div class="test_action">
                                    <button id="test_save" data-prescription_id="<?php ?>" class="btn btn-sm btn-success save">Save</button>
                                    <button class="btn btn-sm btn-danger cancel-btn">Cancel</button>
                                </div>
                            </div>
                            <div class="advice">
                                ...
                                <div class="adv_action">
                                    <button id="adv_save" data-prescription_id="<?php ?>" class="btn btn-sm btn-success save">Save</button>
                                    <button class="btn btn-sm btn-danger cancel-btn">Cancel</button>
                                </div>
                            </div>
                        </div>
...
<script id="new_medicine" type="text/template">
    <div class="med">
        &#9899; <input class="med_name" data-toggle="tooltip"
        ...
        <div class="med_footer">
            <div class="period folded">
                Take for <input class="med_period" type="text"
            ...
            <div class="del_action">
                <button class="btn btn-sm btn-danger delete"><i class="fa fa-trash"
...
<script src="{{ asset('per/script.js') }}"></script>
